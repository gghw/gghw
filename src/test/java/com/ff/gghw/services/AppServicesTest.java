...
public class AppServicesTest {
    ...
    public void testApplyForLoan() {
        ...
        Application application = new Application(0, loan, "client_id", 10000, 1000, 15, "1.2.3.4", timestamp);
    ...
    public void testExtendLoan() {
        ...
        Extension extension = new Extension(0, newLoan, 7, 500, timestamp);
    ...
    public void testIllegalApplicationTimeAndSum() {
        try {
            ...
            Application application = new Application(0, null, "client_id", 10000, 1000, 15, "1.2.3.4", timestamp);
